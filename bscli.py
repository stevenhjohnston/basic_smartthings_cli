...
parser.add_argument("-t", "--token", dest="token",
                    help="Provide a SmartThings Personal Access Token.  These are obtained from the SmartThings website - https://account.smartthings.com/tokens")
...
if token == None:
    print('You must provide a SmartThings API Personal Access Token.  Run "bscli.py -h" for help')
    quit()
...
async def main(token, deviceid, command):
    async with aiohttp.ClientSession() as session:
        ...
        if deviceid == None or command == None:
            ...
            print(t)
            print('Provide SmartThings API Personal Access Token, Device ID and Command "on" or "off" to switch device on/off.  Run bscli.py -h for help')
